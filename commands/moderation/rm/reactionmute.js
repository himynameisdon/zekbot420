...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (!message.member.permissions.has(PermissionFlagsBits.ManageRoles)) {
            return message.reply('You do not have permission to reaction mute members. <:smirk2:1498272372539785286>');
        }
        ...
        if (!me.permissions.has(PermissionFlagsBits.ManageRoles)) {
            return message.reply('I need the **Manage Roles** permission to reaction mute members. <:smirk2:1498272372539785286>');
        }
