...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('status')
        .setDescription('Check zekbot420 service status'),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.editReply('⚠️ **I could not reach the zekbot420 status page**. Try checking manually: ' + STATUS_PAGE);
        }
