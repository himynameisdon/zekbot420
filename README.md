...
### Downloading
- Download and share videos from pretty much any video service. [_If ffmpeg supports it, we got it!_](https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md) (optional; requires yt-dlp and ffmpeg)
